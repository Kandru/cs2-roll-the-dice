...
{
    public class ZoomOut : DiceBlueprint
    {
        public override string ClassName => "ZoomOut";
        public readonly Random _random = new();
        private readonly Dictionary<CCSPlayerController, uint> _oldFOVs = [];

        public ZoomOut(PluginConfig GlobalConfig, MapConfig Config, IStringLocalizer Localizer) : base(GlobalConfig, Config, Localizer)
        {
        ...
        public override void Add(CCSPlayerController player)
        {
            ...
            uint min = _config.Dices.ZoomOut.MinZoomFactor;
            uint max = _config.Dices.ZoomOut.MaxZoomFactor;
